...
// KLEINE LETTERS (a-z) — voor het schrijfspel "Alfa-Blokken". Adrian schrijft
// blokletters (print), dus dit zijn print-vormen, niet cursief. Ze zijn
// getekend op een echte schrijf-liniatuur zodat de groottes kloppen:
//   ascender-top ≈ 0.14 · x-hoogte-top ≈ 0.44 · basislijn ≈ 0.82 · staart ≈ 0.98
// Stok-letters (b d f h k l t) rijzen tot de bovenlijn; staart-letters
// (g j p q y) zakken onder de basislijn; ronde x-letters (a c e o …) blijven
// tussen x-hoogte en basislijn. Streek-volgorde is kind-logisch (boven→onder,
// links→rechts). Meerdere strokes = de letter in losse pennenstreken.
export const LOWER_PATHS = {
  a: [[[.64, .48], [.5, .42], [.35, .48], [.30, .61], [.35, .75], [.5, .82], [.66, .76]], [[.68, .46], [.68, .82]]],
  b: [[[.32, .14], [.32, .82]], [[.32, .54], [.5, .48], [.64, .58], [.64, .72], [.5, .82], [.32, .80]]],
  c: [[[.66, .49], [.5, .42], [.35, .48], [.30, .61], [.35, .75], [.5, .82], [.66, .74]]],
  d: [[[.66, .52], [.5, .48], [.36, .58], [.36, .72], [.5, .82], [.66, .80]], [[.68, .14], [.68, .82]]],
  e: [[[.32, .61], [.68, .61], [.67, .49], [.5, .42], [.35, .48], [.30, .61], [.35, .75], [.5, .82], [.66, .74]]],
  f: [[[.63, .22], [.53, .15], [.43, .20], [.41, .34], [.41, .82]], [[.30, .46], [.58, .46]]],
  g: [[[.66, .50], [.5, .43], [.36, .49], [.32, .61], [.36, .73], [.5, .79], [.66, .72], [.66, .50]], [[.68, .47], [.68, .84], [.60, .95], [.47, .97], [.37, .90]]],
  h: [[[.32, .14], [.32, .82]], [[.32, .56], [.46, .47], [.60, .53], [.64, .65], [.64, .82]]],
  i: [[[.5, .44], [.5, .82]], [[.5, .27], [.5, .33]]],
  j: [[[.55, .44], [.55, .84], [.48, .95], [.37, .96], [.29, .88]], [[.55, .27], [.55, .33]]],
  k: [[[.34, .14], [.34, .82]], [[.64, .46], [.34, .64], [.64, .82]]],
  l: [[[.5, .14], [.5, .78], [.56, .82], [.63, .80]]],
  m: [[[.24, .82], [.24, .48], [.34, .44], [.44, .50], [.46, .62], [.46, .82]], [[.46, .54], [.56, .45], [.66, .50], [.72, .62], [.72, .82]]],
  n: [[[.32, .82], [.32, .46], [.44, .44], [.58, .50], [.64, .62], [.64, .82]]],
  o: [[[.5, .42], [.35, .48], [.30, .61], [.35, .75], [.5, .82], [.65, .75], [.70, .61], [.65, .48], [.5, .42]]],
  p: [[[.32, .44], [.32, .98]], [[.32, .50], [.5, .45], [.64, .54], [.64, .68], [.5, .78], [.32, .76]]],
  q: [[[.68, .50], [.5, .45], [.36, .54], [.36, .68], [.5, .78], [.68, .76]], [[.68, .44], [.68, .98]]],
  r: [[[.36, .82], [.36, .46], [.48, .44], [.62, .52]]],
  s: [[[.64, .49], [.5, .42], [.38, .46], [.37, .56], [.5, .62], [.60, .68], [.56, .78], [.42, .82], [.32, .75]]],
  t: [[[.5, .24], [.5, .74], [.58, .82], [.66, .78]], [[.34, .44], [.64, .44]]],
  u: [[[.32, .44], [.32, .70], [.40, .79], [.54, .82], [.62, .74], [.62, .44], [.62, .82]]],
  v: [[[.32, .44], [.5, .82], [.68, .44]]],
  w: [[[.26, .44], [.38, .82], [.5, .56], [.62, .82], [.74, .44]]],
  x: [[[.34, .44], [.66, .82]], [[.66, .44], [.34, .82]]],
  y: [[[.34, .44], [.5, .68]], [[.66, .44], [.46, .86], [.36, .96]]],
  z: [[[.32, .44], [.66, .44], [.32, .82], [.66, .82]]],
};
